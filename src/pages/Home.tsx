            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center min-h-[60vh]">
                ...
                <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                        ...
                        <button className="px-8 py-3 rounded-xl bg-white/5 border border-white/10 text-white font-bold uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2">
